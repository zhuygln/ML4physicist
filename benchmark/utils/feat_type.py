...
def main():
    ...
    _, _, categorical_indicator, _ = dataset.get_data(target=task.target_name, include_row_id=True)
    ...
    print(feat_type)
    #['Categorical', 'Categorical', 'Numerical', 'Categorical', 'Numerical', 'Categorical', 'Categorical', 'Categorical', 'Categorical', 'Categorical', 'Categorical', 'Categorical', 'Categorical', 'Categorical']
